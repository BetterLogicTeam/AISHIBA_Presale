...
function Footer() {
  return (
    <div>
        <ico-footer _ngcontent-nxk-c21="" _nghost-nxk-c20="">
  <div _ngcontent-nxk-c20="" className="container-fluid footer color-dark-blue">
    <div _ngcontent-nxk-c20="" className="row d-flex align-items-center">
      <div
        _ngcontent-nxk-c20=""
        className="d-flex flex-column flex-lg-row align-items-center justify-content-between"
      >
        <div _ngcontent-nxk-c20="" className="divider d-block d-lg-none" />
        <div
          _ngcontent-nxk-c20=""
    ...
    <div _ngcontent-nxk-c20="" className="row mt-5 bottom align-items-center">
      <div _ngcontent-nxk-c20="" className="col-lg-4">
        <ul
          _ngcontent-nxk-c20=""
          type="none"
          className="d-flex align-items-center justify-content-lg-start justify-content-center font-14 color-dark-blue p-0 m-0 w-100 px-4 px-sm-0"
        >
      ...
      <div _ngcontent-nxk-c20="" className="col-lg-4 d-none d-lg-block">
        <div _ngcontent-nxk-c20="" className="font-14 text-white text-center">
          <span
            _ngcontent-nxk-c20=""
            translate=""
    ...
    <div
      _ngcontent-nxk-c20=""
      className="col-lg-6 d-block d-lg-none my-3 text-center"
    >
      <div _ngcontent-nxk-c20="" className="font-14 text-white">
        <span _ngcontent-nxk-c20="" translate="" className="me-2 color-footer">
          © 2023 AiDoge
        </span>
        <span _ngcontent-nxk-c20="" translate="">
          All Rights Reserved.
