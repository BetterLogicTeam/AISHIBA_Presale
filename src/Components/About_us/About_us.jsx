        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <div className="about_us_contetn">
              ...
              <p>
                AISHIBA is a community-driven organization that is established
                to provide a one stop solution for all kind of traders under one
                platform in the DeFi world. We aim to empower our users with a
                comprehensive solution by providing them a platform that has
                benefits of a centralized exchange and beyond.
                ...
                <div className="col-md-9">
                  <div className="lower_cotetn mt-4">
                    ...
                    <p>
                      ...
                      cross-chain asset exchange network, providing all
                      necessary underlying support for the Defi ecosystem.
                    </p>
                  </div>
                  <div className="lower_cotetn">
                    <h5>Never Ending Liquidity</h5>
                    <p>
                      AISHIBA obtains its liquidity from a variety of exchanges
                      and has the capacity to distribute a single trade
                      transaction across multiple DEXs in order to obtain the
                  ...
                  <div className="lower_cotetn">
                    ...
                    <p>
                      ...
                      pertinent, voting on proposals by the AISHIBA Holders.
                    </p>
                  </div>
                </div>
              </div>
